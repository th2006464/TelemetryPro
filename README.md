...
| 文件 | 大小 | 作用 |
|:---|:---|:---|
| `WorldMapData.kt` | ~580 行 | 7 大洲多边形轮廓 + 208 个城市坐标 |
...
| File | Size | Role |
|:---|:---|:---|
| `WorldMapData.kt` | ~580 lines | 7 continent polygon outlines + 208 city coordinates |
...
│       │       │   ├── WorldMapData.kt   # 7 continents + 208 cities
