        ...
        Box(modifier = Modifier.weight(1f)) {
            when (selectedTab) {
                ...
                3 -> RecordScreen(
                    ...
                    onMarkWaypoint = { label -> viewModel.markWaypoint(label) },
                    onStartBacktrack = { sessionId, reversed -> viewModel.startBacktrack(sessionId, reversed) },
                    onStopBacktrack = { viewModel.stopBacktrack() },
