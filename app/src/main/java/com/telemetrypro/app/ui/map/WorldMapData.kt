...
object WorldMapData {
    ...
    val majorCities: List<City> = listOf(
        ...
        City("新西伯利亚", 82.9f, 55.0f),
        City("叶卡捷琳堡", 60.6f, 56.8f),
        City("克拉斯诺亚尔斯克", 92.9f, 56.0f),
        ...
        City("爱丁堡", -3.2f, 55.9f),
        City("里加", 24.1f, 56.9f),
        City("萨格勒布", 16.0f, 45.8f),
        City("索非亚", 23.3f, 42.7f),
        City("日内瓦", 6.1f, 46.2f),
        City("塞维利亚", -6.0f, 37.4f),
